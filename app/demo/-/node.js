...
(function ($) {
    class $mol_model extends $.$mol_object {
        ...
        json(next, force) {
            ...
            resource.headers = $.$mol_const(Object.assign({}, next ? { 'Authorization': `token ${$.$mol_github_auth.token(['public_repo'])}` } : {}));
...
(function ($) {
    class $mol_rpc_client_frame extends $.$mol_object {
        ...
        frame() {
            ...
            frame.src = this.uri();
            frame.onload = $.$mol_log_group(`${this}.frame() load`, (event) => atom.push(frame));
        ...
        call({ name, args }) {
            ...
            const handle = $.$mol_log_group(`${this}.call(${JSON.stringify({ name, args })}) message`, (event) => {
                ...
                if (event.data.error)
                    atom.push(new Error(event.data.error));
                else
                    atom.push(event.data.result);
            });
...
(function ($) {
    class $mol_chat extends $.$mol_list {
        ...
        add_hint() {
            return $.$mol_locale.text("$mol_chat_add_hint");
        }
        add_body(val, force) {
            return (val !== void 0) ? val : "";
        }
        ...
        add_submit_label() {
            return $.$mol_locale.text("$mol_chat_add_submit_label");
        }
        add(event, force) {
            return (event !== void 0) ? event : null;
        }
...
(function ($) {
    class $mol_app_habhub extends $.$mol_book {
        ...
        Details_content() {
            return ((obj) => {
                obj.rows = () => [].concat(this.Datails_text(), this.Details_chat());
                return obj;
            })(new this.$.$mol_list);
        }
        Datails_text() {
    ...
    __decorate([
        $.$mol_mem
    ], $mol_app_habhub.prototype, "Details_chat", null);
    __decorate([
        $.$mol_mem
    ], $mol_app_habhub.prototype, "gist_current_issue", null);
    __decorate([
        $.$mol_mem_key
...
(function ($) {
    class $mol_app_bench extends $.$mol_view {
        ...
        addon_title() {
            return $.$mol_locale.text("$mol_app_bench_addon_title");
        }
        Filter() {
            return ((obj) => {
        ...
        sandbox_title() {
            return $.$mol_locale.text("$mol_app_bench_sandbox_title");
        }
        Sandbox() {
            return ((obj) => {
                obj.dom_name = () => "iframe";
        ...
        result_col_title_sample() {
            return $.$mol_locale.text("$mol_app_bench_result_col_title_sample");
        }
    }
    __decorate([
        $.$mol_mem
...
(function ($) {
    class $mol_app_demo extends $.$mol_book {
        ...
        Detail() {
            return ((obj) => {
                ...
                obj.body = () => [].concat(this.Detail_list(), this.Chat());
                obj.event_top = (val) => this.event_front_up(val);
                return obj;
    ...
    __decorate([
        $.$mol_mem
    ], $mol_app_demo.prototype, "Chat", null);
    __decorate([
        $.$mol_mem_key
