    ...
    $.$mol_test({
        ...
        'Custom class as component'() {
            class Button {
                ...
                render() { return $.$mol_dom_jsx("button", { id: this.props.id }, this.props.text); }
            }
            const dom = $.$mol_dom_jsx(Button, { id: "$mol_dom_jsx_test", text: "click me" });
            $.$mol_assert_equal(dom.outerHTML, '<button id="$mol_dom_jsx_test">click me</button>');
        },
...
(function ($) {
    function $mol_dom_jsx(Elem, props, ...children) {
        ...
        if (typeof Elem === 'string') {
            ...
            const props2 = props;
            node = new Elem(Object.assign({ childNodes: children }, props2));
            if (node['render'])
                node = node['render']();
        }
        return node;
...
(function ($) {
    class $mol_app_bench_list_tsx {
        ...
        static render() {
            return ($.$mol_dom_jsx("div", { id: "list", className: "list" }, this.data.items.map(item => ($.$mol_dom_jsx("div", { id: 'list-item#' + item.id, className: `list-item list-item-selected-${this.selected === item.id}`, onclick: this.onClick.bind(this, item) },
